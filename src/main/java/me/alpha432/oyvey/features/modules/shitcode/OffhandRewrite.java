 ...
 */
package me.alpha432.oyvey.features.modules.shitcode;
...
extends Module {
    ...
    public OffhandRewrite() {
        super("OffhandRewrite", "Allows you to switch up your Offhand. - Perry Phobos Paste", Module.Category.SHITCODE, true, false, false);
        instance = this;
